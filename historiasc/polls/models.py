...
class Historialesclinicos(models.Model):
    idhistorialesclinicos = models.AutoField(primary_key=True)
    fecha = models.DateTimeField()
    formato = models.TextField()
    profesionales_idprofesional = models.ForeignKey('Profesionales', models.DO_NOTHING, db_column='profesionales_idprofesional')
    pacientes_idpacientes = models.ForeignKey('Pacientes', models.DO_NOTHING, db_column='pacientes_idpacientes')
